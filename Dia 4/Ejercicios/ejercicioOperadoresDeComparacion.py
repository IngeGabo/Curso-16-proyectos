# Ejercicio Operadores de Comparación 1:
# Crea dos variables (num1 y  num2) con los valores 36 y 17 respectivamente. Verifica si num1 es mayor o igual que num2 y almacena el resultado de dicha comparación
...
# Ejercicio Operadores de Comparación 2
...
# Ejercicio Operadores de Comparación 3
# Crea dos variables (num1 y  num2):
